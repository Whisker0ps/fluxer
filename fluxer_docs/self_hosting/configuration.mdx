...
<Note>
When self-hosting: the static CDN URL (scripts, fonts, favicons) is set at **runtime** from your config (`domain.base_domain`, `endpoint_overrides.static_cdn`, etc.). The same image works for any domain; you do not need to put your config in the repo or build with your domain.
</Note>
